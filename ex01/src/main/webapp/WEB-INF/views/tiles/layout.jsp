...
<body>
	...
	<footer>
		<!-- S footer -->
	<div id="footerBox">
		<div id="downQuickBox"><div id="downQuick"><a href="/" title="Home">HOME</a>
		<a href="/SUB/?ctId=13" title="개인정보취급방침"><span class="bold">개인정보취급방침</span></a>
		<a href="/BBS/msList.php?tId=entrance" title="온라인 입학상담">온라인 입학상담</a><a href="/SUB/?ctId=53" class="last" title="오시는 길">오시는 길</a></div></div>
		<div id="footer">
	...
	<address><span class="bold">(주)예담직업전문학교</span> 대구광역시 중구 중앙대로 403 (남일동 135-1, 5층)				<span class="colorCCC">/</span>
		...
		<p>
			...
			<span class="colorCCC">/</span>
			<span class="bold">개인정보보호책임자</span>:서강중 (ask@yedam.ac)
		</p>
